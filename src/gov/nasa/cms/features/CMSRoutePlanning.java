...
import gov.nasa.worldwindx.applications.sar.SARApp;
import gov.nasa.worldwindx.applications.sar.SARKey;
 ...
 * @author twchoi
 */
public class CMSRoutePlanning extends JFrame {
    ...
    private void newTrackFromURL(String urlString, String name)
    {
        if (urlString == null)
        {
            Object input = JOptionPane.showInputDialog(CMSRoutePlanning.this, "Enter a track URL", "Add New Track",
...
//        CMSRoutePlanning appFrame = new CMSRoutePlanning();
//        appFrame.setVisible(true);
        
        //ApplicationTemplate.start("Route p", ApplicationTemplate.AppFrame.class);
    
        try {
            CMSRoutePlanning rp = new CMSRoutePlanning();
            //rp.initialize();
            rp.setTitle("Route Planning");
