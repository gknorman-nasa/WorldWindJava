...
//            = "gov/nasa/worldwindx/examples/data/AirspaceBuilder-DemoShapes.zip";
    ...
    protected static class CelestialMapperModel extends AbstractTableModel {
    ...
    protected static class CelestialMapperPanel extends JPanel {

        protected JComboBox factoryComboBox;
        protected JTable entryTable;
        protected boolean ignoreSelectEvents = false;

        public CelestialMapperPanel(CelestialMapperModel model, CelestialMapperController controller) {
        ...
        protected void initComponents(CelestialMapperModel model, final CelestialMapperController controller) {
    ...
    //**************************************************************//
    protected static class CelestialMapperController extends WWObjectImpl implements ActionListener, MouseListener,
            AirspaceEditListener {

        protected AppFrame app;
        protected CelestialMapperModel model;
        protected CelestialMapperPanel view;
        ...
        public CelestialMapperController(AppFrame app) {
            this.app = app;
        ...
        public CelestialMapperModel getModel() {
            return this.model;
        }

        public void setModel(CelestialMapperModel model) {
            this.model = model;
        }

        public CelestialMapperPanel getView() {
            return this.view;
        }

        public void setView(CelestialMapperPanel view) {
            this.view = view;
        }
...
//            }
    ...
    protected static class AppFrame extends ApplicationTemplate.AppFrame {
        ...
        protected CelestialMapperModel builderModel;
        protected CelestialMapperPanel builderView;
        protected CelestialMapperController builderController;

        public AppFrame() {
            this.airspaceLayer = new RenderableLayer();
            this.airspaceLayer.setName(CMS_LAYER_NAME);
            insertBeforePlacenames(this.getWwd(), this.airspaceLayer);

            this.builderController = new CelestialMapperController(this);
            this.builderModel = new CelestialMapperModel();
            this.builderView = new CelestialMapperPanel(this.builderModel, this.builderController);
        ...
        public static void makeMenuBar(JFrame frame, final CelestialMapperController controller) {
