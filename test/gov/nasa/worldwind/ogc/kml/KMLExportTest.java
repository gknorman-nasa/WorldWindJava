...
/**
 * Test export of KML by writing shapes to KML and validating the resulting
 * document against the KML schema.
 */
...
public class KMLExportTest
{
     ...
     *
     * @return Collection of object[]. Each object[] holds parameters for one
